...
Naming::Convention - Naming or Renaming( for identifiers, mostly )


=head1 VERSION

This document describes Naming::Convention version 0.0.4


=head1 SYNOPSIS

    use Naming::Convention qw/naming renaming/;
